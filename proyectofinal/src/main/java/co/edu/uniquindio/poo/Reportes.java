...
public class Reportes {
    ...
    /**
     * Constructor por defecto de la clase Reportes.
     */
    public Reportes(){
    }

    /**
     * Constructor de la clase Reportes con parámetros para inicializar todos los atributos.
     *
     ...
     * del objeto Reportes, incluyendo el nombre del empleado, el total de transacciones o actividades,
